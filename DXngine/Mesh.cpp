...
{
	CreateBuffers(vert, numVertices, indices, numIndices, device); //Create the buffers
}
...
//Used to create the vertex and index buffers
void Mesh::CreateBuffers(Vertex* vert, int numVertices, unsigned int* indices, int numIndices, ID3D11Device* device)
{
